...
import 'package:clock_challenge/generated/json/weather_response_entity_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case WeatherResponse:
			return weatherResponseEntityFromJson(data as WeatherResponse, json) as T;			case WeatherResponseLife:
			return weatherResponseLifeFromJson(data as WeatherResponseLife, json) as T;			case LocationResponse:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case WeatherResponse:
			return weatherResponseEntityToJson(data as WeatherResponse);			case WeatherResponseLife:
			return weatherResponseLifeToJson(data as WeatherResponseLife);			case LocationResponse:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'WeatherResponseEntity':
			return WeatherResponse().fromJson(json);			case 'WeatherResponseLife':
			return WeatherResponseLife().fromJson(json);			case 'LocationResponse':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'WeatherResponseEntity':
			return List<WeatherResponse>();			case 'WeatherResponseLife':
			return List<WeatherResponseLife>();			case 'LocationResponse':
